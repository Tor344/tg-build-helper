...
class Floor(Model):
    ...
    floor_number = fields.IntField()  # Номер этажа (например, 1, 2, -1 для подвала)
    is_basement = fields.BooleanField(default=False)  # Подвал (да/нет)
    is_attic = fields.BooleanField(default=False)  # Мансарда (да/нет)
